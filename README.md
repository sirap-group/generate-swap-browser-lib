<h1 align="center">
  ...
  <br>
  −− generate-swap-browser-lib −−
  <br>
  <br>
</h1>

<p align="center">
  <a href="https://travis-ci.org/sirap-group/generate-swap-browser-lib" target="_blank">
    <img alt="Build Status" src="https://travis-ci.org/sirap-group/generate-swap-browser-lib.svg?branch=master"/>
  </a>

  <a href="https://www.npmjs.com/package/generate-swap-browser-lib">
    <img src="https://img.shields.io/npm/dm/generate-swap-browser-lib.svg" alt="npm downloads">
  </a>

  <a href="https://npmjs.org/package/generate-swap-browser-lib" target="_blank">
    <img alt="NPM version" src="https://badge.fury.io/js/generate-swap-browser-lib.svg"/>
  </a>
...
<h4 align="center">
  −− Generate your browser library project in seconds! Featuring StandardJS+ESNext+BabelJS+WebPack+YarnScripts+Mocha. −−
  <br>
  <br>
  <a href="https://www.npmjs.com/package/generate-swap-browser-lib" target="_blank">
    <img alt="NPM Stats" src="https://nodei.co/npm/generate-swap-browser-lib.png?downloads=true&downloadRank=true&stars=true"/>
  </a>
</h4>
...
```sh
$ yarn gobal add generate-swap-browser-lib
```

or

```sh
$ npm install --global generate-swap-browser-lib
```
...
```sh
$ yarn add generate-swap-browser-lib
```

or

```sh
$ npm install --save generate-swap-browser-lib
```
...
```js
import generateSwapBrowserLib from 'generate-swap-browser-lib'
import isValid from 'is-valid-app'

export default function (app) {
  if (!isValid(app, 'generate-my-generator')) return

  app.use(generateSwapBrowserLib)

  // ... your generator's stuff
}
```

Then you can use directly any 'generate-swap-browser-lib' tasks as a `generate-my-generator` task.

```
$ gen my-generator:example-task
```

Should run `generate-swap-browser-lib:example-task` on your own generator instance.
...
export default function (app) {
  ...
  app.register('swap-browser-lib', generateSwapBrowserLib)

  // ... your generator's stuff
}
```

Then you can acces easily any `generate-swap-browser-lib` tasks as a `generate-my-generator` sub-generator task.

```
$ gen my-generator.swap-browser-lib:example-task
```
...
```sh
$ git clone git@github.com:sirap-group/generate-swap-browser-lib.git
$ cd generate-swap-browser-lib
$ yarn install
```
#### Running test
